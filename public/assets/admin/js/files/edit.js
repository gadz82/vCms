...
(function(yourcode){
	...
	$(function(){
		...
		$('button[id="generate-thumbnails"]').on('click', function(e){
			e.preventDefault();
			var btn = $(this),
				id_file = btn.data('id-file');
			var spinner = $('<i class="fa fa-spinner fa-spin"></i>');
			btn.addClass('disabled').after(spinner);
			$.ajax({
				url: '/admin/files/regenerateSingleFile/'+id_file,
				type: 'GET',
				cache: false,
