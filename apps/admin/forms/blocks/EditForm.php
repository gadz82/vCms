...
class EditForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $select_app = isset($this->view->Applicazioni) ? $this->view->Tags : \Applicazioni::find(['conditions' => 'attivo = 1 AND id = ' . $entity->id_applicazione, 'columns' => 'id,descrizione', 'order' => 'descrizione ASC']);
        $id_app = new Select(
            'id_applicazione',
            $select_app,
            [
        ...
        $select_block_tag = isset($this->view->BlocksTags) ? $this->view->BlocksTags : \BlocksTags::find(['conditions' => 'attivo = 1', 'columns' => 'id,descrizione', 'order' => 'id ASC']);
        $id_bt = new Select(
            'id_block_tag',
            $select_block_tag,
            [
    ...
    private function prepareValidation($id_tipologia_stato)
    {
        ...
        $arr_exclude_required['1'] = ['data_fine_pubblicazione'];
        $arr_exclude_required['default'] = ['data_fine_pubblicazione'];
