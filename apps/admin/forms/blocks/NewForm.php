...
class NewForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $select_block_tag = isset($this->view->BlocksTags) ? $this->view->BlocksTags : \BlocksTags::find(['conditions' => 'attivo = 1', 'columns' => 'id,descrizione', 'order' => 'descrizione ASC']);
        $id_bt = new Select(
            'id_block_tag',
            $select_block_tag,
            [
        ...
        $this->fields['content']->setAttribute('rows', '10')->setAttribute('class', 'form-control wysiwyg')->setAttribute('autofocus', true);
