...
class EditForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $id_meta_group = new Select('id_meta_group', $select_gruppo_meta, ['class' => 'form-control selectpicker', 'using' => ['id', 'descrizione'], 'data-style' => 'btn-flat btn-white', 'data-size' => 5, 'data-width' => '100%', 'data-live-search' => true, 'data-selected-text-format' => 'count>1', 'useEmpty' => false, 'emptyText' => '---']);
        ...
        $hidden = new Check('hidden', ['class' => 'ichek']);
    ...
    private function prepareValidation($id_tipologia_stato)
    {
        ...
        $arr_exclude_required['1'] = ['nota', 'nota_new', 'dataset'];
        $arr_exclude_required['default'] = ['nota', 'nota_new', 'dataset'];
