...
class NewForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $id_meta_group = new Select('id_meta_group', $select_gruppo_meta,
            [
                'class'                     => 'form-control selectpicker',
                'using'                     => ['id', 'descrizione'],
                'data-style'                => 'btn-flat btn-white', 'data-size' => 5, 'data-width' => '100%', 'data-live-search' => true,
                'data-selected-text-format' => 'count>1',
                'useEmpty'                  => false, 'emptyText' => '---']
        );
