...
class NewForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $exclude_fields = ['id', 'data_creazione', 'data_aggiornamento', 'id_utente', 'attivo', 'visible', 'header'];
        $order_fields = [];
        ...
        $this->fields['ordine']->setAttribute('value', '1');
    ...
    private function prepareValidation($id_tipologia_stato)
    {
        ...
        $arr_exclude_required['1'] = ['risorsa', 'azione', 'id_padre'];
        $arr_exclude_required['default'] = ['risorsa', 'azione', 'id_padre'];
