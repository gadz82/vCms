...
class EditForm extends Form {
    ...
    public function initialize($entity=null, $options=array()){
        ...
        $exclude_fields['Posts'] = array('id','data_creazione','data_aggiornamento','id_utente','attivo', 'id_tipologia_post');
        ...
        $select_app = isset($this->view->Applicazioni) ? $this->view->Applicazioni: \Applicazioni::find(array('conditions'=>'attivo = 1 AND id = '. $entity->id_applicazione,'columns'=>'id,descrizione','order'=>'descrizione ASC'));
    ...
    private function generateMetaBoxes(){
        ...
        foreach($meta_groups as $meta){
            ...
            $metafields = \Meta::find(array('conditions' => 'id_meta_group ='.$meta->id, 'order' => 'priorita ASC'));
