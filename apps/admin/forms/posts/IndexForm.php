...
class IndexForm extends Form
{
    ...
    public function initialize($entity = null, $options = null)
    {
        ...
        $exclude_fields = ['id', 'attivo', 'id_utente', 'testo', 'excerpt'];
        ...
        if (empty($id_app)) {
            $select_app = isset($this->view->Applicazioni) ? $this->view->Applicazioni : \Applicazioni::find(['conditions' => 'attivo = 1', 'columns' => 'id,descrizione', 'order' => 'id ASC']);
