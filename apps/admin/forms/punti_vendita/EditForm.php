...
class EditForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $this->fields['id_tipologia_stato']->setLabel('Stato punto vendita');
        $this->fields['id_tipologia_punto_vendita']->setLabel('Tipologia punto vendita');

        $this->fields['id_tipologia_stato']->setAttribute('useEmpty', false)->setAttribute('grid_class', 'col-sm-6');;
        $this->fields['id_tipologia_punto_vendita']->setAttribute('useEmpty', false)->setAttribute('grid_class', 'col-sm-6');;
