...
class EditForm extends Form {
	...
	public function initialize($entity=null, $options=array()){
        ...
        $this->fields['id_tipologia_stato']->setLabel('Stato volantino')->setAttribute('grid_class', 'col-sm-6')->setAttribute('cleanImages', true);
        $this->fields['id_tipologia_volantino']->setLabel('Tipologia volantino')->setAttribute('grid_class', 'col-sm-6')->setAttribute('cleanImages', true);
        ...
        $this->fields['id_punto_vendita']->setLabel('Punto vendita')->setAttribute('cleanImages', true);

        $this->fields['id_punto_vendita']->setAttribute('grid_class', 'col-sm-6')->setAttribute('cleanImages', true);
        $this->fields['id_regione']->setAttribute('grid_class', 'col-sm-6')->setAttribute('cleanImages', true);
        $this->fields['numero']->setAttribute('grid_class', 'col-sm-6')->setAttribute('cleanImages', true);
        $this->fields['anno']->setAttribute('grid_class', 'col-sm-6')->setAttribute('cleanImages', true);
	...
	private function prepareValidation($id_tipologia_stato){
		...
		$arr_exclude_required['1'] = array('id_punto_vendita');
		$arr_exclude_required['default'] = array('id_punto_vendita');
