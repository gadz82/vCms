...
class NewForm extends Form {
	...
	public function initialize($entity=null, $options=array()){
		...
		$this->fields['descrizione']->setAttribute('grid_class', 'col-xs-12');
	...
	private function prepareValidation($id_tipologia_stato){
		...
		$arr_exclude_required['1'] = array('nota','nota_new', 'filtri_group_post_types');
		$arr_exclude_required['default'] = array('nota','nota_new', 'filtri_group_post_types');
