...
class IndexForm extends Form
{
    ...
    public function initialize($entity = null, $options = null)
    {
        ...
        // Generazione campi
        $fields = $this->getAutoRenderByModel(new \FiltriGroup(), 'FiltriGroup', $exclude_fields, $order_fields, true);
        $fields['data_creazione']->setAttribute('class', 'form-control date-format');
        $fields['data_aggiornamento']->setAttribute('class', 'form-control date-format');
