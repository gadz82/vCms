...
class IndexForm extends Form
{
    ...
    public function initialize($entity = null, $options = null)
    {
        ...
        $exclude_fields = ['id', 'attivo', 'id_utente', 'descrizione', 'data_creazione'];
        ...
        $oto = new Select('ono_to_one',
            ...
            ['class' => 'form-control selectpicker', 'data-style' => 'btn-flat btn-white', 'multiple' => 'multiple', 'data-size' => 5, 'data-width' => '100%', 'useEmpty' => false, 'emptyText' => '---']
        );
        ...
        $required = new Select('required',
            ...
            ['class' => 'form-control selectpicker', 'data-style' => 'btn-flat btn-white', 'data-size' => 5, 'multiple' => 'multiple', 'data-width' => '100%', 'data-selected-text-format' => 'count>1', 'useEmpty' => false, 'emptyText' => '---']
        );
