...
class EditForm extends Form {
    ...
    public function initialize($entity=null, $options=array()){
        ...
        $select_app = isset($this->view->Applicazioni) ? $this->view->Tags: \Applicazioni::find(array('conditions'=>'attivo = 1 AND id = '.$entity->id_applicazione,'columns'=>'id,descrizione','order'=>'id ASC'));
        $id_app = new Select(
            'id_applicazione',
            $select_app,
            [
