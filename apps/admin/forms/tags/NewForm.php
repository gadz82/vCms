...
class NewForm extends Form {
	...
	public function initialize($entity=null, $options=array()){
        ...
        $select_app = isset($this->view->Applicazioni) ? $this->view->Tags: \Applicazioni::find(array('conditions'=>'attivo = 1','columns'=>'id,descrizione','order'=>'descrizione ASC'));
	...
	private function prepareValidation($id_tipologia_stato){
		...
		$arr_exclude_required['1'] = array('content');
		$arr_exclude_required['default'] = array('content');
