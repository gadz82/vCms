...
class EditForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $exclude_fields = ['id', 'id_applicazione', 'data_creazione', 'id_applicazione', 'data_aggiornamento', 'id_utente', 'attivo'];
        $order_fields = [];
        ...
        if (isset($entity)) {
            ...
            $this->add(new Hidden('id_applicazione', ['hidden' => true, 'value' => $entity->id_applicazione]));
        }
        /* FINE BLOCCO */
