...
class IndexForm extends Form {
	...
	public function initialize($entity=null, $options=null){
		...
		$exclude_fields = array('id', 'attivo', 'id_utente', 'validation_token', 'token_validated', 'password', 'validation_expiration_date', 'reset_password_expiration_date', 'password_reset_token', 'localita', 'indirizzo', 'data_aggiornamento', 'cap');
