...
class NewForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $exclude_fields = ['id', 'id_applicazione', 'data_cambio_stato', 'data_creazione', 'data_aggiornamento', 'attivo'];
        $order_fields = [];
    ...
    private function prepareValidation($id_tipologia_stato)
    {
        ...
        $arr_exclude_required['1'] = ['ip_autorizzati'];
        $arr_exclude_required['default'] = ['ip_autorizzati'];
