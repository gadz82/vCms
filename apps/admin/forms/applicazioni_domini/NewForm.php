...
class NewForm extends Form {
	...
	public function initialize($entity=null, $options=array()){
		...
		$exclude_fields = array('id', 'id_applicazione','data_cambio_stato','data_creazione','data_aggiornamento','attivo');
		$order_fields = array();
		
		$this->fields = $this->getAutoRenderByModel(new \ApplicazioniDomini(), 'ApplicazioniDomini', $exclude_fields, $order_fields, false);
	...
	private function prepareValidation($id_tipologia_stato){
		...
		$arr_exclude_required['1'] = array('ip_autorizzati');
		$arr_exclude_required['default'] = array('ip_autorizzati');
