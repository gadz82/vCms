...
class IndexForm extends Form {
	...
	public function initialize($entity=null, $options=null){
        ...
        $select_posts = isset($this->view->Posts) ? $this->view->Posts : \Posts::find(array('conditions' => 'attivo = 1', 'columns' => 'id,titolo', 'order' => 'id ASC'));
        $id_post = new Select('id_post[]', $select_posts, array(
        ...
        $select_forms = isset($this->view->Forms) ? $this->view->Forms : \Forms::find(array('conditions' => 'attivo = 1', 'columns' => 'id,titolo', 'order' => 'id ASC'));
        $id_form = new Select('id_form[]', $select_forms, array(
            'class' => 'form-control selectpicker',
            'using' => array('id', 'titolo'),
            'data-style' => 'btn-flat btn-white',
            'multiple' => 'multiple',
