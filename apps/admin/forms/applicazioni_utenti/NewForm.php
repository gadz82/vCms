...
class NewForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        $exclude_fields = ['id', 'data_cambio_stato', 'data_creazione', 'data_aggiornamento', 'attivo'];
        $order_fields = [];
        ...
        $id_utente = new Select('id_utente_applicazione', $select_utente, ['class' => 'form-control selectpicker', 'using' => ['id', 'descrizione'], 'data-style' => 'btn-flat btn-white', 'data-size' => 5, 'data-width' => '100%', 'data-live-search' => true, 'data-selected-text-format' => 'count>1', 'useEmpty' => false, 'emptyText' => '---']);
