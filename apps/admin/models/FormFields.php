...
class FormFields extends BaseModel
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'FormRequestsFields', 'id_form_field', ['alias' => 'FormRequestsFields', 'reusable' => true]);
        $this->belongsTo('id_form', '\Forms', 'id', ['alias' => 'Forms']);
        $this->belongsTo('id_tipologia_form_fields', '\TipologieFormFields', 'id', ['alias' => 'TipologieFormFields', 'reusable' => true]);
        $this->belongsTo('id_tipologia_stato', '\TipologieStatoFormFields', 'id', ['alias' => 'TipologieStatoFormFields', 'reusable' => true]);
