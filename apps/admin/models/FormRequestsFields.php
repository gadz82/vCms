...
class FormRequestsFields extends BaseModel
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('id_form_field', '\FormFields', 'id', ['alias' => 'FormFields', 'reusable' => true]);
        $this->belongsTo('id_form_request', '\FormRequests', 'id', ['alias' => 'FormRequests', 'reusable' => true]);
        $this->belongsTo('id_form', '\Forms', 'id', ['alias' => 'Forms', 'reusable' => true]);
    }
