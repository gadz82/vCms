...
class SecurityPlugin extends Plugin {
	...
	private $public_resources = array (
        'session' => array (
            'index',
            'login'
        ),
	...
	public function __construct($wl = array()){
	...
	public function rebuild() {
		...
		$risorse = \RuoliPermessi::find ( array (
				'attivo = 1',
		...
		foreach ( $utenti as $utente ) {
			...
			// risorse private
			$ruoli_permessi = \RuoliPermessi::find ( array (
	...
	public function getMenu($id_ruolo, $livello) {
		$ruoliMenu = \RuoliMenu::find ( array (
