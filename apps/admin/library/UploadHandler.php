...
class UploadHandler
{
    ...
    public function setOptions($options = null, $initialize = true, $error_messages = null)
    {
        $this->response = [];
        $this->options = [
    ...
    {
        $file = new \stdClass ();
        $file->original_name = $this->get_file_name($uploaded_file, $name, $size, $type, $error, $index, $content_range);

        if (isset($this->options['orginal_filename']) && $this->options['orginal_filename']) {
    ...
    protected function generate_unique_filename($file_path, $name, $size, $type, $error, $index, $content_range)
    {
    ...
    protected function handle_form_data($file, $index)
    {
        ...
        if (isset ($_POST ['id_entity']) && !empty ($_POST ['id_entity'])) {
            $file->name = $_POST ['id_entity'] . '_' . $file->name;
        }
    }
