...
<section class="content-header">
	<h1>Volantini <small>crea</small></h1>
	<ol class="breadcrumb">
...
<section class="content">
	...
	{{ form('admin/volantini/create', 'method':'post', 'autocomplete':'off', 'class':'', 'name':'form-edit', 'id':'form-edit', 'novalidate':'novalidate') }}
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Volantino - Nuovo</h3>
