...
<section class="content-header">
	<h1>Punti Vendita <small>crea</small></h1>
	<ol class="breadcrumb">
		<li>{{ link_to('admin/index/index', '<i class="fa fa-home"></i>Home') }}</li>
		<li>{{ link_to('admin/punti_vendita/index', 'Punti Vendita') }}</li>
		<li class="active">Dettaglio punto vendita</li>
	</ol>
	{{ get_content() }}
...
<section class="content">
	...
	{{ form('admin/punti_vendita/create', 'method':'post', 'autocomplete':'off', 'class':'', 'name':'form-edit', 'id':'form-edit', 'novalidate':'novalidate') }}
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Punto Vendita - Nuovo</h3>
					...
					<div class="box-footer text-right">
						...
						{{ link_to('admin/punti_vendita/index', 'Indietro', 'class':'btn btn-primary btn-flat') }}
					</div>
