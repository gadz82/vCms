<script type="text/javascript">
	...
	var selected =  <?= $filtri_group_selected_post_types; ?>;

</script>

<section class="content-header">
	<h1>Gruppi Filtri <small>dettaglio</small></h1>
	<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Gruppo Filtri - Id Gruppo Filtri | <strong>{{ controller_data.id }}</strong></h3>
