<script type="text/javascript">
	...
	var selected =  <?= $meta_group_selected_post_types; ?>;
</script>

<section class="content-header">
	<h1>Gruppi Meta <small>dettaglio</small></h1>
	<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Gruppo Meta - Id Gruppo Meta | <strong>{{ controller_data.id }}</strong></h3>
