...
<section class="content-header">
	<h1>Permessi Admin <small>ricerca</small></h1>
	<ol class="breadcrumb">
		<li><a href="<?= $this->url->get("admin/index/index"); ?>"><i class="fa fa-home"></i>Home</a></li>
		<li class="active">Permessi Admin</li>
	</ol>
	{{ flashSession.output() }}
</section>
	...
	<div id="box-container-search" class="row">
		<div class="col-xs-12">
			<div class="box box-solid">
                ...
                {{ form('ruoli_permessi/search', 'method':'post', 'autocomplete':'off', 'id':'form_admin_ruoli_permessi') }}
