...
<section class="content-header">
	<h1>Traduzioni Stringhe <small>ricerca</small></h1>
	<ol class="breadcrumb">
		<li><a href="<?= $this->url->get("admin/index/index"); ?>"><i class="fa fa-home"></i>Home</a></li>
		<li class="active">Traduzioni Stringhe</li>
	</ol>
	{{ flashSession.output() }}
</section>
	...
	<div id="box-container-search" class="row">
		<div class="col-xs-12">
			<div class="box box-solid">
                ...
                {{ form('flat_translations/search', 'method':'post', 'autocomplete':'off', 'id':'form_admin_flat_translations') }}
