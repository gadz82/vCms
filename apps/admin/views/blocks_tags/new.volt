...
<section class="content-header">
	<h1>Tag Blocchi <small>crea</small></h1>
	<ol class="breadcrumb">
		<li>{{ link_to('admin/index/index', '<i class="fa fa-home"></i>Home') }}</li>
		<li>{{ link_to('admin/blocks_tags/index', 'Tag Blocchi') }}</li>
		<li class="active">Dettaglio tag blocco</li>
	</ol>
	{{ get_content() }}
...
<section class="content">
	...
	{{ form('admin/blocks_tags/create', 'method':'post', 'autocomplete':'off', 'class':'', 'name':'form-edit', 'id':'form-edit', 'novalidate':'novalidate') }}
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Tag Blocco - Nuovo</h3>
					...
					<div class="box-footer text-right">
						...
						{{ link_to('admin/blocks_tags/index', 'Indietro', 'class':'btn btn-primary btn-flat') }}
					</div>
