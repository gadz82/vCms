...
<section class="content-header">
	<h1>
		Utenti<small>ricerca</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?= $this->url->get("admin/index/index"); ?>"><i
	...
	<div id="box-container-search" class="row">
		<div class="col-xs-12">
			<div class="box box-solid">
				...
				{{ form('utenti/search', 'method':'post', 'autocomplete':'off',
				'id':'form_admin_utenti') }}
				...
				<div class="box-footer text-right">
					<div id="cerca" class="btn btn-primary btn-flat">
						<i class="fa fa-search fa-fw"></i> Cerca
					</div>
					<div id="pulisci" class="btn btn-primary btn-flat">
						<i class="fa fa-eraser fa-fw"></i> Pulisci
					</div>
					<div id="esporta" class="btn btn-primary btn-flat">
						<i class="fa fa-mail-forward fa-fw"></i> Esporta
					</div>
				</div>
