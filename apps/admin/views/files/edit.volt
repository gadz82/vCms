...
<section class="content-header">
	<h1>Files <small>dettaglio</small></h1>
	<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">File - Id File | <strong>{{ controller_data.id }}</strong></h3>
					...
					<div class="box-footer text-right">
						...
						{{ link_to('admin/files/index', 'Indietro', 'class':'btn btn-primary btn-flat') }}
					</div>
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Anteprime Tagli immagine</strong></h3>
						<span class="fa fa-chevron-down fa-fw pull-right"></span>
	                </div>
	                ...
	                <div class="box-body">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										{% for index,img in anteprime %}
											{% if index is even %}
											<div class="row">
											{% endif %}
											<div class="col-xs-6">
												<h4>{{img['size']}}</h4>
												<img style="max-width:30vw" src="{{img['file']}}?str={{ date('Ymdhis') }}">
											</div>
											{% if index is odd %}
											</div>
											{% endif %}
								...
								<div class="row">
									<div class="col-xs-12 text-center">
										<button class="btn btn-primary btn-success" id="generate-thumbnails" data-id-file="{{id}}">Rigenera Miniature</button>
									</div>
								</div>
							</div>
						</div>
