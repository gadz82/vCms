...
stylesheet_link('assets/admin/css/font-awesome/font-awesome.min.css') }} {{
assets.outputCss('cssTheme') }} {{ assets.outputCss() }} {% if
...
<body class="skin-blue fixed">
	...
	<div class="wrapper">
		...
		{% include "partials/header" with ['user': auth_user, 'header_alert':
		header_alert] %} {% include "partials/sidebar" with ['user_menu':
		auth_menu] %}
	...
	assets.outputJs('jsTheme') }} {{ javascript_include('assets/admin/js/common.js') }}
