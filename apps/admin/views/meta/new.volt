...
<section class="content-header">
	<h1>Meta <small>crea</small></h1>
	<ol class="breadcrumb">
		<li>{{ link_to('admin/index/index', '<i class="fa fa-home"></i>Home') }}</li>
		<li>{{ link_to('admin/meta/index', 'Meta') }}</li>
		<li class="active">Dettaglio meta</li>
	</ol>
	{{ get_content() }}
...
<section class="content">
	...
	{{ form('admin/meta/create', 'method':'post', 'autocomplete':'off', 'class':'', 'name':'form-edit', 'id':'form-edit', 'novalidate':'novalidate') }}
			...
			<div class="col-xs-12">
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<h3 class="box-title">Meta - Nuovo Meta</h3>
					...
					<div class="box-footer text-right">
						...
						{{ link_to('admin/meta/index', 'Indietro', 'class':'btn btn-primary btn-flat') }}
					</div>
