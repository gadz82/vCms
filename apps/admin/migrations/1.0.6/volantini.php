...
/**
 * Class VolantiniMigration_106
 */
class VolantiniMigration_106 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('volantini', [
                ...
                'indexes' => [
                    ...
                    new Index('anno', ['anno', 'numero', 'attivo'], 'UNIQUE'),
                ...
                'references' => [
                    new Reference(
                        'volantini_ibfk_2',
                        [
                            'referencedTable' => 'tipologie_volantino',
                            'columns' => ['id_tipologia_volantino'],
                    ...
                    new Reference(
                        'volantini_ibfk_5',
                        [
                            'referencedTable' => 'punti_vendita',
                            'columns' => ['id_punto_vendita'],
                            'referencedColumns' => ['id'],
                            'onUpdate' => 'CASCADE',
                            'onDelete' => 'CASCADE'
                        ]
