...
class PostsController extends ControllerBase
{
    ...
    public function initialize()
    {
        ...
        $this->jqGrid_columns = [
            ...
            ['label' => 'Stato post', 'name' => 'id_tipologia_stato'],
            ['label' => 'Tipo post', 'name' => 'id_tipologia_post'],
            ['label' => 'Data Creazione', 'name' => 'data_creazione']
        ];
    ...
    public function newAction()
    {
        ...
        $this->addLibraryAssets(['jQueryValidation', 'codemirror', 'jQueryFileUpload', 'bootstrapWysihtml5', 'dataTables', 'lazyload', 'jQueryPostMessage'], $this->controllerName . '-new');
    ...
    public function editAction($id)
    {
        ...
        $this->addLibraryAssets(['jQueryValidation', 'jQueryFileUpload', 'codemirror', 'bootstrapWysihtml5', 'dataTables', 'lazyload', 'jQueryPostMessage'], $this->controllerName . '-edit');
