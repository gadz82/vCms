...
class FormFieldsController extends ControllerBase {
	...
	public function initialize(){
		...
		$this->jqGrid_columns = array(
				array('label'=>'Stato campo form', 'name'=>'id_tipologia_stato'),
				array('label'=>'Tipo campo form', 'name'=>'id_tipologia_form_field')
		);
	}
	...
	public function createAction(){
        ...
        if($this->request->isAjax() == true){
            ...
            if(!$form_fields->save()){
                ...
                $rs = $this->view->getRender('form_fields', 'formFieldsList', array('form_fields' => $form_fields), function ($view){
            ...
            if($this->request->isPost()){
                ...
                if($form->isValid($params)){
                    ...
                    if($controller_data->save()){
                        ...
                        $this->response->setJsonContent(array('success' => $this->alert_messagge['successUpdate'], 'data' => $rs));
                    }else{
                        $messages = array();
                        ...
                        $this->response->setJsonContent(array('success' => $this->alert_messagge['failUpdate'], 'data' => implode(' | ',$messages)));
                    }
                ...
                $rs = $this->view->getRender('form_fields', 'formFieldsEditForm', array('form_form_fields_edit' => $form, 'id_form_field' => $controller_data->id), function ($view){
                    $view->setViewsDir("../apps/admin/views/partials/");
                    $view->setRenderLevel(\Phalcon\Mvc\View::LEVEL_LAYOUT);
                });
