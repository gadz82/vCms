...
class UtentiController extends ControllerBase
{
    ...
    public function getUtentiFromGruppiUtentiAction()
    {
        ...
        $utenti = \Utenti::query()->columns('Utenti.id, Utenti.nome_utente')->innerJoin('GruppiUtenti', 'gu.id_utente = Utenti.id AND gu.id_gruppo = :id_gruppo: AND gu.attivo = 1', 'gu')->where('Utenti.attivo = 1')->bind([
            'id_gruppo' => $id
