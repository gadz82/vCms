...
class FiltriValoriController extends ControllerBase
{
    ...
    public function initialize()
    {
        ...
        $this->jqGrid_columns = [
            ['label' => 'Filtro', 'name' => 'id_filtro'],
            ['label' => 'Valore Filtro', 'name' => 'valore'],
            ['label' => 'Chiave Valore', 'name' => 'key'],
    ...
    public function checkFiltroAction($id_filro)
    {
        ...
        $this->response->setJsonContent(['data' => $rs, 'has_select' => ($has_parent || $has_children)]);
        return $this->response;
    }
