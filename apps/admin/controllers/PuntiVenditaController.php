...
class PuntiVenditaController extends ControllerBase
{
    ...
    public function initialize()
    {
        ...
        $this->jqGrid_columns = [
            ['label' => 'ID Conad', 'name' => 'id_pdv'],
            ['label' => 'Nome PDV', 'name' => 'nome'],
            ['label' => 'Regione', 'name' => 'id_regione'],
            ['label' => 'Indirizzo', 'name' => 'address'],
            ['label' => 'Stato punto vendita', 'name' => 'id_tipologia_stato'],
            ['label' => 'Tipo punto vendita', 'name' => 'id_tipologia_punto_vendita'],
            ['label' => 'Coordinate', 'name' => 'lat']
        ];
