...
class FiltriController extends ControllerBase {
	...
	public function initialize(){
		...
		$this->jqGrid_columns = array(
            ...
            array('label'=>'Nome', 'name'=>'titolo'),
            array('label'=>'Stato filtro', 'name'=>'id_tipologia_stato'),
            array('label'=>'Gruppo Filtri', 'name'=>'id_filtri_group'),
            array('label'=>'Obbligatorio', 'name'=>'required'),
            array('label'=>'Tipo filtro', 'name'=>'id_tipologia_filtro')
		);
