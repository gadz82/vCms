...
<head>
    ...
    <title>Benvenuto - Conferma la tua identità e attiva il tuo account</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 40px 40px 20px; text-align: center;">
                <h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 27px; color: #333333; font-weight: normal;"> Attivazione dell'account Utente</h1>
            </td>
        </tr>
        <tr>
            <td bgcolor="#ffffff" style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: center;">
                <p style="margin: 0;">Ciao {{params['nome']}} grazie per esserti registrato al sito, clicca sul pulsante sottostante per verificare la tua identità e attivare il tuo account.</p>
            </td>
        </tr>
        <tr>
                ...
                <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                    <tr>
                        ...
                        <td style="border-radius: 3px; background: #d11717; text-align: center;" class="button-td">
                            <a href="{{params['tokenUrl']}}" style="background: #c8d008; border: 15px solid #c8d008; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                &nbsp;<span style="color:#ffffff;">Attiva Account</span>&nbsp;&nbsp;&nbsp;&nbsp;
                            </a>
                        </td>
                    </tr>
                </table>
    ...
    <table role="presentation" aria-hidden="true" style="margin: auto;" class="email-container" width="600" cellspacing="0" cellpadding="0" border="0" align="center">
        <tr>
            <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; line-height:18px; text-align: center; color: #fff !important;" class="x-gmail-data-detectors">
                <webversion style="color:#fff; text-decoration:underline; font-weight: bold;"><a href="https://www.gustourconad.it">www.gustourconad.it</a></webversion>
            </td>
        </tr>
    </table>
