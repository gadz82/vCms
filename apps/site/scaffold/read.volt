    ...
    <div class="container clearfix">
        ...
        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
            ...
            <li class="breadcrumb-item active" itemprop="itemListElement" itemscope
                itemtype="http://schema.org/ListItem">
                <a href="{{ applicationUrl ~ post_type.slug }}/{{ post.slug }}" itemscope
                ...
                <div class="single-post nobottommargin">
                    ...
                    <div class="entry clearfix">
                        ...
                        <div class="entry-image">
                            <a href="/files/{{ post.immagine.filename }}" data-lightbox="image"><img class="image_fade"
                                                                                                     src="/files/{{ post.immagine.filename }}"
                                                                                                     alt="{{ post.titolo }}"></a>
                        </div><!-- .entry-image end -->
                        {% if post.meta_immagini_gallery is not empty and post.meta_immagini_gallery is not null %}
                            <div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-margin="20"
                                 data-nav="true" data-pagi="false" data-items-xxs="2" data-items-xs="3"
                                 data-items-sm="4" data-items-md="5">

                                {% for img in post.meta_immagini_gallery %}
                                    <div class="oc-item">
                                        <a href="/files/{{ img.filename }}" data-lightbox="image"><img
                                                    src="/files/small/{{ img.filename }}" class="image_fade"
                                                    alt="{{ img.alt }}"></a>
                                    </div>
                                {% endfor %}
                            </div>
